...
# Перенесём коммиты из ветки feature в develop
git rebase feature
...
<img width="849" height="345" alt="image" src="https://github.com/user-attachments/assets/23cb41ac-d782-4d32-af45-215070f70c97" />


```bash
# Перейти в ветку master
git checkout master
# Перенесём коммиты из ветки develop в master
git rebase develop
# Выведем историю коммитов develop
git log --oneline --graph develop
...
<img width="842" height="476" alt="image" src="https://github.com/user-attachments/assets/4d2d68f3-bc4a-4385-a2b9-1c71be684d5a" />

История коммитов до:

<img width="885" height="183" alt="image" src="https://github.com/user-attachments/assets/7dad9ea5-bca5-4960-834c-6d476f5a122a" />
<img width="847" height="303" alt="image" src="https://github.com/user-attachments/assets/9e055c02-72f7-476b-a986-dcbbe5e60bec" />
